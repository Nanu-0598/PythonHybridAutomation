...
class Add_Customer_Page:
    ...
    cust_roles_drp_xpath = "//input[@role='searchbox']"
    cusrole_guests_xpath = "//li[text()='Guests']"
    cusrole_administrators_xpath = "//li[text()='Administrators']"
    cusrole_forummoderators_xpath = "//li[text()='Forum Moderators']"
    cusrole_registered_xpath = "(//li[text()='Registered'])[2]"
    cusrole_vendors_xpath = "//li[text()='Vendors']"
    ...
    def select_customer_role(self, role):
        elements = self.driver.find_elements(By.XPATH, self.cust_roles_drp_xpath)
