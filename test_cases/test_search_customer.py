...
class Test_Search_Customer:
    ...
    def test_search_customer_by_email(self, setup):
        ...
        self.driver = setup
        self.driver.implicitly_wait(28)
    ...
    def test_search_customer_by_companyname(self, setup):
        ...
        self.search_custmr = Search_Customer_Page(self.driver)
        self.search_custmr.enter_customer_companyname("Indian Cricket Team")
        self.search_custmr.click_search_button()
        time.sleep(3)
        is_cmpname_present = self.search_custmr.search_customer_by_company("Indian Cricket Team")
